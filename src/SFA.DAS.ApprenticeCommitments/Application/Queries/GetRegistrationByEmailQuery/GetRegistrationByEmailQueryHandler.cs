...
{
    public class GetRegistrationByEmailQueryHandler : IRequestHandler<GetRegistrationByEmailQuery, Registration>
    {
        ...
        public async Task<Registration> Handle(GetRegistrationByEmailQuery request, CancellationToken cancellationToken)
        {
